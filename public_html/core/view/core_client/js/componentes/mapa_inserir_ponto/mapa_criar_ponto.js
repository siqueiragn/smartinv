...
function iniciaMapa() {
    ...
    var template = {
        externalGraphic: BASE_URL + "/libs_client/js/componentes/maps/openLayers/img/marker-gold.png",
        graphicWidth: 23,
        graphicHeight: 23
    };
    ...
    marcadorPonto = new OpenLayers.Feature.Vector(pointGeometry);
    camadaPonto.addFeatures(marcadorPonto);
    ...
    $("#coordenadaX, #coordenadaY").blur(function() {
        var lonlat = converteCoordenadasAoContrario($("#coordenadaX").val(), $("#coordenadaY").val());
        marcadorPonto.move(new OpenLayers.LonLat(lonlat.lat, lonlat.lon));
